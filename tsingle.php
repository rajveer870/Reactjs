...
<div class="col-md-9">
	<div class="col-md-5 grid">		
		<div class="flexslider">
			  <ul class="slides">
			    <li data-thumb="images/ts1.jpeg">
			        <div class="thumb-image"> <img src="images/ts1.jpeg" data-imagezoom="true" class="img-responsive"> </div>
			    </li>
			    <li data-thumb="images/ts2.jpeg">
			         <div class="thumb-image"> <img src="images/ts2.jpeg" data-imagezoom="true" class="img-responsive"> </div>
			    </li>
			    <li data-thumb="images/ts3.jpeg">
			       <div class="thumb-image"> <img src="images/ts3.jpeg" data-imagezoom="true" class="img-responsive"> </div>
			    </li> 
				<li data-thumb="images/ts4.jpeg">
				   <div class="thumb-image"> <img src="images/ts4.jpeg" data-imagezoom="true" class="img-responsive"></div>
				</li>
				<li data-thumb="images/ts5.jpeg">
				   <div class="thumb-image"> <img src="images/ts5.jpeg" data-imagezoom="true" class="img-responsive"></div>
				</li>
...
<div class="col-md-7 single-top-in">
						<div class="single-para simpleCart_shelfItem">
							<h2>T-Shirt For Men</h2>
							<p>Buy The Widest Range Of Branded Men's Full Sleeve And Half Sleeve V-neck,Round Neck And Polo T-shirt With The Best Price In India</p>
							<div class="star-on">
								<ul>
			...
			<div class="content-top1">
				<div class="col-md-4 col-md4">
					<div class="col-md1 simpleCart_shelfItem">
						<a href="single2.php">
							<img class="img-responsive" src="images/ts6.jpeg" alt="" />
						</a>
						<h3><a href="single2.php">T-shirt</a></h3>
						<div class="price">  
			...
			<div class="col-md-4 col-md4">
					<div class="col-md1 simpleCart_shelfItem">
						<a href="single4.php">
							<img class="img-responsive" src="images/ts11.jpeg" alt="" />
						</a>
						<h3><a href="single4.php">T-shirt</a></h3>
						<div class="price">
								<h5 class="item_price">&#8377; 599</h5>
								<a href="#" class="item_add">Add To Cart</a>
								<div class="clearfix"> </div>
			...
			<div class="col-md-4 col-md4">
					<div class="col-md1 simpleCart_shelfItem">
						...
						<h3><a href="single6.php">T-shirt</a></h3>
						<div class="price">
								<h5 class="item_price">&#8377; 599</h5>
								<a href="#" class="item_add">Add To Cart</a>
								<div class="clearfix"> </div>
