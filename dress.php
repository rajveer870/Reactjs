	...
	<div class="container">
		...
		<div class="col-md-9">
			<div class="content-top1">
				<div class="col-md-4 col-md4">
					<div class="col-md1 simpleCart_shelfItem">
						<a href="dre.php">
							<img class="img-responsive" src="images/dr1.jpeg" alt="" />
						</a>
						<h3><a href="dre.php">Dress</a></h3>
						<div class="price">
			...
			<div class="col-md-4 col-md4">
					<div class="col-md1 simpleCart_shelfItem">
						<a href="dre3.php">
							<img class="img-responsive" src="images/dr8.jpeg" alt="" />
						</a>
						<h3><a href="dre3.php">Dress</a></h3>
						<div class="price">
								<h5 class="item_price">&#8377; 799</h5>
								<a href="#" class="item_add">Add To Cart</a>
								<div class="clearfix"> </div>
			...
			<div class="content-top1">
				<div class="col-md-4 col-md4">
					<div class="col-md1 simpleCart_shelfItem">
						<a href="dre4.php">
							<img class="img-responsive" src="images/dr12.jpeg" alt="" />
						</a>
						<h3><a href="dre4.php">Dress</a></h3>
						<div class="price">
								<h5 class="item_price">&#8377; 701</h5>
								<a href="#" class="item_add">Add To Cart</a>
								<div class="clearfix"> </div>
						</div>
					</div>
			...
			<div class="col-md-4 col-md4">
					<div class="col-md1 simpleCart_shelfItem">
						<a href="dre5.php">
							<img class="img-responsive" src="images/dr16.jpeg" alt="" />
						</a>
						<h3><a href="dre5.php">Dress</a></h3>
						<div class="price">
								<h5 class="item_price">&#8377; 699</h5>
								<a href="#" class="item_add">Add To Cart</a>
								<div class="clearfix"> </div>
			...
			<div class="col-md-4 col-md4">
					<div class="col-md1 simpleCart_shelfItem">
						<a href="dre6.php">
							<img class="img-responsive" src="images/dr20.jpeg" alt="" />
						</a>
						<h3><a href="dre6.php">Dress</a></h3>
						<div class="price">
			...
			<div class="content-top1">
				<div class="col-md-4 col-md4">
					<div class="col-md1 simpleCart_shelfItem">
						<a href="dre7.php">
							<img class="img-responsive" src="images/dr22.jpeg" alt="" />
						</a>
						<h3><a href="dre7.php">Dress</a></h3>
						<div class="price">
								<h5 class="item_price">&#8377; 699</h5>
								<a href="#" class="item_add">Add To Cart</a>
								<div class="clearfix"> </div>
			...
			<div class="col-md-4 col-md4">
					<div class="col-md1 simpleCart_shelfItem">
						<a href="dre8.php">
							<img class="img-responsive" src="images/dr25.jpeg" alt="" />
						</a>
						<h3><a href="dre8.php">Dress</a></h3>
						<div class="price">
								<h5 class="item_price">&#8377; 799</h5>
								<a href="#" class="item_add">Add To Cart</a>
								<div class="clearfix"> </div>
			...
			<div class="col-md-4 col-md4">
					<div class="col-md1 simpleCart_shelfItem">
						<a href="dre9.php">
							<img class="img-responsive" src="images/dr30.jpeg" alt="" />
						</a>
						<h3><a href="dre9.php">Dress</a></h3>
						<div class="price">
								<h5 class="item_price">&#8377; 599</h5>
								<a href="#" class="item_add">Add To Cart</a>
								<div class="clearfix"> </div>
