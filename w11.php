				   ...
				   <!-- Collect the nav links, forms, and other content for toggling -->
					<div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
						<ul class="nav navbar-nav nav_1">
										...
										<div class="tab-content">
										  <div class="tab-pane active" id="men">
											<ul class="nav-list <!--list-inline-->">
												<li><a href="tops.php">Tops</a><br><!--<img src="images/t7.jpg" class="img-responsive" alt=""/></a>--></li>
												<li><a href="dress.php">Dress</a><!--<img src="images/t8.jpg" class="img-responsive" alt=""/></a>--></li>
												<li><a href="wjeans.php">Jeans</a><!--<img src="images/t9.jpg" class="img-responsive" alt=""/></a>--></li>
												<li><a href="sarees.php">Sarees</a><!--<img src="images/t12.jpg" class="img-responsive" alt=""/></a>--></li>
												<li><a href="dupattas.php">Dupattas</a><!--<img src="images/t12.jpg" class="img-responsive" alt=""/></a>--></li>
											</ul>
										  </div>
									   </div>
									</div>
								...
								<div class="dropdown-menu mega-dropdown-menu">
									<div class="container-fluid">
										...
										<div class="tab-content">
										  <div class="tab-pane active" id="men">
											<ul class="nav-list <!--list-inline-->">
												<li><a href="tshirt.php">T-shirt</a><!--<img src="images/t10.jpg" class="img-responsive" alt=""/></a>--></li>
												<li><a href="shirts.php">Shirt</a><!--<img src="images/t2.jpg" class="img-responsive" alt=""/></a>--></li>
												<li><a href="mjeans.php">Jeans</a><!--<img src="images/t3.jpg" class="img-responsive" alt=""/></a>--></li>
												<li><a href="blazers.php">Blazers</a><!--<img src="images/t5.jpg" class="img-responsive" alt=""/></a>--></li>
												<li><a href="trouser.php">Trouser</a><!--<img src="images/t6.jpg" class="img-responsive" alt=""/></a>--></li>
											</ul>				
										  </div>
							...
							<!--<li><a href="adminlog.php"><font color="grey"> Admin block</font></a></li>-->
						</ul>
					 </div><!-- /.navbar-collapse -->
...
<div class="breadcrumbs">
		<div class="container">
			<ol class="breadcrumb breadcrumb1 animated wow slideInLeft animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: slideInLeft;">
				...
				<li class="active">Accessaries</li>
			</ol>
		</div>
	</div>
<div class="single">
...
<div class="col-md-9">
	<div class="col-md-5 grid">		
		<div class="flexslider">
			  <ul class="slides">
			    <li data-thumb="images/w11.jpeg">
			        <div class="thumb-image"> <img src="images/w11.jpeg" data-imagezoom="true" class="img-responsive"> </div>
			    </li>
			    <li data-thumb="images/w12.jpeg">
			         <div class="thumb-image"> <img src="images/w12.jpeg" data-imagezoom="true" class="img-responsive"> </div>
			    </li>
			    <li data-thumb="images/w13.jpeg">
			       <div class="thumb-image"> <img src="images/w13.jpeg" data-imagezoom="true" class="img-responsive"> </div>
			    </li> 
				<li data-thumb="images/w14.jpeg">
				   <div class="thumb-image"> <img src="images/w14.jpeg" data-imagezoom="true" class="img-responsive"></div>
				</li>
				<li data-thumb="images/w15.jpeg">
				   <div class="thumb-image"> <img src="images/w15.jpeg" data-imagezoom="true" class="img-responsive"></div>
				</li>
...
<div class="col-md-7 single-top-in">
						<div class="single-para simpleCart_shelfItem">
							<h2>Classy Leather Wallets For Men</h2>
							<p>High on functionlity and utility, this this genuine leather wallet is all you need to carry your essentials in your place.this classy wallet is equipped with  mutiple compartments to store your cards, cash, coins and IDs.</p>
							<div class="star-on">
								<ul>
							...
							<div class="clearfix"> </div>
								...
								<label  class="add-to item_price">&#8377; 299</label>
			...
			<div class="content-top1">
				<div class="col-md-4 col-md4">
					<div class="col-md1 simpleCart_shelfItem">
						<a href="w6.php">
							<img class="img-responsive" src="images/w6.jpeg" alt="" />
						</a>
						<h3><a href="w6.php">Wallet</a></h3>
						<div class="price">  
			...
			<div class="col-md-4 col-md4">
					<div class="col-md1 simpleCart_shelfItem">
						<a href="w23.php">
							<img class="img-responsive" src="images/w23.jpeg" alt="" />
						</a>
						<h3><a href="w23.php">Wallet</a></h3>
						<div class="price">
								<h5 class="item_price">&#8377; 239</h5>
								<a href="#" class="item_add">Add To Cart</a>
								<div class="clearfix"> </div>
						</div>
			...
			<div class="col-md-4 col-md4">
					<div class="col-md1 simpleCart_shelfItem">
						<a href="w15.php">
							<img class="img-responsive" src="images/w15.jpeg" alt="" />
						</a>
						<h3><a href="w15.php">Wallet</a></h3>
						<div class="price">
								<h5 class="item_price">&#8377; 199</h5>
								<a href="#" class="item_add">Add To Cart</a>
								<div class="clearfix"> </div>
						</div>
		...
		<div class="container">
				...
				<div class="col-md-3 footer-bottom-cate animated wow fadeInLeft" data-wow-delay=".5s">
					...
					<ul>
						...
						<li><a href="sharee.php">Sharee</a></li>
				...
				<div class="clearfix"> </div>
				<p class="footer-class animated wow fadeInUp animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: fadeInUp;"> © 2019 Vatss Fashion . All Rights Reserved | Design by <a href="http://Csegroup.com/" target="_blank">Vatss Group</a> (CSE G.P. Dhanbad (2016-1019) </p>
			</div>
	</div>
</div>
<!--footer-->
