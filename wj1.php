...
<div class="breadcrumbs">
		<div class="container">
			<ol class="breadcrumb breadcrumb1 animated wow slideInLeft animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: slideInLeft;">
				...
				<li class="active">Women Jeans</li>
			</ol>
		</div>
	</div>
<div class="single">
...
<div class="col-md-9">
	<div class="col-md-5 grid">		
		<div class="flexslider">
			  <ul class="slides">
			    <li data-thumb="images/wj1.jpeg">
			        <div class="thumb-image"> <img src="images/wj1.jpeg" data-imagezoom="true" class="img-responsive"> </div>
			    </li>
			    <li data-thumb="images/wj2.jpeg">
			         <div class="thumb-image"> <img src="images/wj2.jpeg" data-imagezoom="true" class="img-responsive"> </div>
			    </li>
			    <li data-thumb="images/wj3.jpeg">
			       <div class="thumb-image"> <img src="images/wj3.jpeg" data-imagezoom="true" class="img-responsive"> </div>
			    </li> 
				<li data-thumb="images/wj4.jpeg">
				   <div class="thumb-image"> <img src="images/wj4.jpeg" data-imagezoom="true" class="img-responsive"></div>
				</li>
				<li data-thumb="images/wj5.jpeg">
				   <div class="thumb-image"> <img src="images/wj5.jpeg" data-imagezoom="true" class="img-responsive"></div>
				</li>
...
<div class="col-md-7 single-top-in">
						<div class="single-para simpleCart_shelfItem">
							<h2>bold and solid collection of jeans for men and women.</h2>
							<p>the jeans feature is a pre-shrunk cotton materisl which makes it comfortable to wear. This gives the jeans a touch of comfort with style.</p>
							<div class="star-on">
								<ul>
							...
							<div class="clearfix"> </div>
								...
								<label  class="add-to item_price">&#8377; 1199</label>
			...
			<div class="content-top1">
				<div class="col-md-4 col-md4">
					<div class="col-md1 simpleCart_shelfItem">
						<a href="wj6.php">
							<img class="img-responsive" src="images/wj6.jpeg" alt="" />
						</a>
						<h3><a href="wj6.php">Jeans</a></h3>
						<div class="price">  
								<h5 class="item_price">&#8377; 1449</h5>
			...
			<div class="col-md-4 col-md4">
					<div class="col-md1 simpleCart_shelfItem">
						<a href="wj32.php">
							<img class="img-responsive" src="images/wj32.jpeg" alt="" />
						</a>
						<h3><a href="wj32.php">Jeans</a></h3>
						<div class="price">
								<h5 class="item_price">&#8377; 1399</h5>
								<a href="#" class="item_add">Add To Cart</a>
								<div class="clearfix"> </div>
						</div>
			...
			<div class="col-md-4 col-md4">
					<div class="col-md1 simpleCart_shelfItem">
						<a href="wj18.php">
							<img class="img-responsive" src="images/wj18.jpeg" alt="" />
						</a>
						<h3><a href="wj18.php">Jeans</a></h3>
						<div class="price">
								<h5 class="item_price">&#8377; 1259</h5>
								<a href="#" class="item_add">Add To Cart</a>
								<div class="clearfix"> </div>
						</div>
