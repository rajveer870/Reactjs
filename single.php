...
<div class="breadcrumbs">
		<div class="container">
			<ol class="breadcrumb breadcrumb1 animated wow slideInLeft animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: slideInLeft;">
				...
				<li class="active">men's Products</li>
			</ol>
		</div>
	</div>
<div class="single">
...
<div class="col-md-9">
	<div class="col-md-5 grid">		
		<div class="flexslider">
			  <ul class="slides">
			    <li data-thumb="images/s1.jpeg">
			        <div class="thumb-image"> <img src="images/s1.jpeg" data-imagezoom="true" class="img-responsive"> </div>
			    </li>
			    <li data-thumb="images/s2.jpeg">
			         <div class="thumb-image"> <img src="images/s2.jpeg" data-imagezoom="true" class="img-responsive"> </div>
			    </li>
			    <li data-thumb="images/s3.jpeg">
			       <div class="thumb-image"> <img src="images/s3.jpeg" data-imagezoom="true" class="img-responsive"> </div>
			    </li> 
				<li data-thumb="images/s5.jpeg">
				   <div class="thumb-image"> <img src="images/s5.jpeg" data-imagezoom="true" class="img-responsive"></div>
				</li>
				<li data-thumb="images/s4.jpeg">
				   <div class="thumb-image"> <img src="images/s4.jpeg" data-imagezoom="true" class="img-responsive"></div>
				</li>
				<li data-thumb="images/s6.jpeg">
				   <div class="thumb-image"> <img src="images/s6.jpeg" data-imagezoom="true" class="img-responsive"></div>
				</li>
...
<div class="col-md-7 single-top-in">
						<div class="single-para simpleCart_shelfItem">
							<h2>Hot Deal With Men's letest collection</h2>
							<p>levis red tape men regular fit casual shirt</p>
							<div class="star-on">
								<ul>
			...
			<div class="content-top1">
				<div class="col-md-4 col-md4">
					<div class="col-md1 simpleCart_shelfItem">
						<a href="single2.php">
							<img class="img-responsive" src="images/s7.jpeg" alt="" />
						</a>
						<h3><a href="single2.php">shirt</a></h3>
						<div class="price">  
			...
			<div class="col-md-4 col-md4">
					<div class="col-md1 simpleCart_shelfItem">
						<a href="single4.php">
							<img class="img-responsive" src="images/s16.jpeg" alt="" />
						</a>
						<h3><a href="single4.php">shirt</a></h3>
						<div class="price">
			...
			<div class="col-md-4 col-md4">
					<div class="col-md1 simpleCart_shelfItem">
						<a href="single6.php">
							<img class="img-responsive" src="images/s25.jpeg" alt="" />
						</a>
						<h3><a href="single6.php">shirt</a></h3>
						<div class="price">
								<h5 class="item_price">&#8377; 499</h5>
								<a href="#" class="item_add">Add To Cart</a>
								<div class="clearfix"> </div>
