		...
		<div class="col-md-9">
			<div class="content-top1">
				<div class="col-md-4 col-md4">
					<div class="col-md1 simpleCart_shelfItem">
						<a href="blaze.php">
							<img class="img-responsive" src="images/bl1.jpeg" alt="" />
						</a>
						<h3><a href="blaze.php">blazzer</a></h3>
						<div class="price">
								<h5 class="item_price">&#8377; 3999</h5>
			...
			<div class="col-md-4 col-md4">
					<div class="col-md1 simpleCart_shelfItem">
						...
						<h3><a href="blaze3.php">blazzer</a></h3>
						<div class="price">
			...
			<div class="content-top1">
				<div class="col-md-4 col-md4">
					<div class="col-md1 simpleCart_shelfItem">
						<a href="blaze4.php">
							<img class="img-responsive" src="images/bl15.jpeg" alt="" />
						</a>
			...
			<div class="col-md-4 col-md4">
					<div class="col-md1 simpleCart_shelfItem">
						<a href="blaze5.php">
							<img class="img-responsive" src="images/bl17.jpeg" alt="" />
						</a>
						<h3><a href="blaze5.php">blazzer</a></h3>
						<div class="price">
								<h5 class="item_price">&#8377; 3599</h5>
								<a href="#" class="item_add">Add To Cart</a>
								<div class="clearfix"> </div>
						</div>
			...
			<div class="content-top1">
				<div class="col-md-4 col-md4">
					<div class="col-md1 simpleCart_shelfItem">
						<a href="blaze7.php">
							<img class="img-responsive" src="images/bl25.jpeg" alt="" />
						</a>
						<h3><a href="blaze7.php">blazzer</a></h3>
						<div class="price">
								<h5 class="item_price">&#8377; 2999</h5>
								<a href="#" class="item_add">Add To Cart</a>
								<div class="clearfix"> </div>
						</div>
					</div>
			...
			<div class="col-md-4 col-md4">
					<div class="col-md1 simpleCart_shelfItem">
						<a href="blaze8.php">
							<img class="img-responsive" src="images/bl30.jpeg" alt="" />
						</a>
						<h3><a href="blaze8.php">blazzer</a></h3>
						<div class="price">
								<h5 class="item_price">&#8377; 3599</h5>
								<a href="#" class="item_add">Add To Cart</a>
								<div class="clearfix"> </div>
			...
			<div class="col-md-4 col-md4">
					<div class="col-md1 simpleCart_shelfItem">
						<a href="blaze9.php">
							<img class="img-responsive" src="images/bl35.jpeg" alt="" />
						</a>
						<h3><a href="blaze9.php">blazzer</a></h3>
						<div class="price">
								<h5 class="item_price">&#8377; 2399</h5>
								<a href="#" class="item_add">Add To Cart</a>
								<div class="clearfix"> </div>
						</div>
