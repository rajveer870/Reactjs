...
<div class="breadcrumbs">
		<div class="container">
			<ol class="breadcrumb breadcrumb1 animated wow slideInLeft animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: slideInLeft;">
				...
				<li class="active">Womens Products</li>
			</ol>
		</div>
	</div>
<div class="single">
...
<div class="col-md-9">
	<div class="col-md-5 grid">		
		<div class="flexslider">
			  <ul class="slides">
			    <li data-thumb="images/sc24.jpeg">
			        <div class="thumb-image"> <img src="images/sc24.jpeg" data-imagezoom="true" class="img-responsive"> </div>
			    </li>
			    <li data-thumb="images/sc25.jpeg">
			         <div class="thumb-image"> <img src="images/sc25.jpeg" data-imagezoom="true" class="img-responsive"> </div>
			    </li>			   
				<li data-thumb="images/sc26.jpeg">
			         <div class="thumb-image"> <img src="images/sc26.jpeg" data-imagezoom="true" class="img-responsive"> </div>
			    </li>			   
				<li data-thumb="images/sc27.jpeg">
			         <div class="thumb-image"> <img src="images/sc27.jpeg" data-imagezoom="true" class="img-responsive"> </div>
			    </li>
...
<div class="col-md-7 single-top-in">
						<div class="single-para simpleCart_shelfItem">
							<h2>women's latest scrabes,stoles and dupattas</h2>
							<p>red lady chiffon colloured and printed dupatts with new drop</p>
							<div class="star-on">
								<ul>
			...
			<div class="content-top1">
				<div class="col-md-4 col-md4">
					<div class="col-md1 simpleCart_shelfItem">
						<a href="sc20.php">
							<img class="img-responsive" src="images/sc20.jpeg" alt="" />
						</a>
						<h3><a href="sc20.php">Dupatta</a></h3>
						<div class="price">  
			...
			<div class="col-md-4 col-md4">
					<div class="col-md1 simpleCart_shelfItem">
						<a href="sc5.php">
							<img class="img-responsive" src="images/sc5.jpeg" alt="" />
						</a>
						<h3><a href="sc5.php">Dupatta</a></h3>
						<div class="price">
			...
			<div class="col-md-4 col-md4">
					<div class="col-md1 simpleCart_shelfItem">
						<a href="sc14.php">
							<img class="img-responsive" src="images/sc14.jpeg" alt="" />
						</a>
						<h3><a href="sc14.php">Dupatta</a></h3>
						<div class="price">
								<h5 class="item_price">&#8377; 159</h5>
								<a href="#" class="item_add">Add To Cart</a>
								<div class="clearfix"> </div>
						</div>
