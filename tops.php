		...
		<div class="col-md-9">
			<div class="content-top1">
				<div class="col-md-4 col-md4">
					<div class="col-md1 simpleCart_shelfItem">
						<a href="top1.php">
							<img class="img-responsive" src="images/tp1.jpg" alt="" />
						</a>
						<h3><a href="top1.php">Top</a></h3>
						<div class="price">
			...
			<div class="col-md-4 col-md4">
					<div class="col-md1 simpleCart_shelfItem">
						...
						<h3><a href="top3.php">Top</a></h3>
						<div class="price">
								<h5 class="item_price">&#8377; 399
								</h5>
								<a href="#" class="item_add">Add To Cart</a>
								<div class="clearfix"> </div>
						</div>
			...
			<div class="col-md-4 col-md4">
					<div class="col-md1 simpleCart_shelfItem">
						<a href="top5.php">
							<img class="img-responsive" src="images/tp16.jpeg" alt="" />
						</a>
						<h3><a href="top5.php">Top</a></h3>
						<div class="price">
								<h5 class="item_price">&#8377; 599</h5>
								<a href="#" class="item_add">Add To Cart</a>
								<div class="clearfix"> </div>
			...
			<div class="col-md-4 col-md4">
					<div class="col-md1 simpleCart_shelfItem">
						<a href="top6.php">
							<img class="img-responsive" src="images/tp21.jpeg" alt="" />
						</a>
						<h3><a href="top6.php">Top</a></h3>
						<div class="price">
								<h5 class="item_price">&#8377; 499</h5>
								<a href="#" class="item_add">Add To Cart</a>
								<div class="clearfix"> </div>
			...
			<div class="content-top1">
				<div class="col-md-4 col-md4">
					<div class="col-md1 simpleCart_shelfItem">
						<a href="top7.php">
							<img class="img-responsive" src="images/tp24.jpeg" alt="" />
						</a>
						<h3><a href="top7.php">Top</a></h3>
						<div class="price">
			...
			<div class="col-md-4 col-md4">
					<div class="col-md1 simpleCart_shelfItem">
						<a href="top8.php">
							<img class="img-responsive" src="images/tp28.jpeg" alt="" />
						</a>
						<h3><a href="top8.php">Top</a></h3>
						<div class="price">
								<h5 class="item_price">&#8377; 399</h5>
								<a href="#" class="item_add">Add To Cart</a>
								<div class="clearfix"> </div>
			...
			<div class="col-md-4 col-md4">
					<div class="col-md1 simpleCart_shelfItem">
						<a href="top9.php">
							<img class="img-responsive" src="images/tp32.jpeg" alt="" />
						</a>
						<h3><a href="top9.php">Top</a></h3>
						<div class="price">
								<h5 class="item_price">&#8377; 499</h5>
								<a href="#" class="item_add">Add To Cart</a>
								<div class="clearfix"> </div>
