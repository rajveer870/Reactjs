...
<div class="breadcrumbs">
		<div class="container">
			<ol class="breadcrumb breadcrumb1 animated wow slideInLeft animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: slideInLeft;">
				...
				<li class="active">Man's Shirt</li>
			</ol>
		</div>
	</div>
<div class="single">
...
<div class="col-md-9">
	<div class="col-md-5 grid">		
		<div class="flexslider">
			  <ul class="slides">
			    <li data-thumb="images/s16.jpeg">
			        <div class="thumb-image"> <img src="images/s16.jpeg" data-imagezoom="true" class="img-responsive"> </div>
			    </li>
			    <li data-thumb="images/s17.jpeg">
			         <div class="thumb-image"> <img src="images/s17.jpeg" data-imagezoom="true" class="img-responsive"> </div>
			    </li>
			    <li data-thumb="images/s18.jpeg">
			       <div class="thumb-image"> <img src="images/s18.jpeg" data-imagezoom="true" class="img-responsive"> </div>
			    </li> 
				<li data-thumb="images/s19.jpeg">
				   <div class="thumb-image"> <img src="images/s19.jpeg" data-imagezoom="true" class="img-responsive"></div>
				</li>
				<li data-thumb="images/s20.jpeg">
				   <div class="thumb-image"> <img src="images/s20.jpeg" data-imagezoom="true" class="img-responsive"></div>
...
<div class="col-md-7 single-top-in">
			...
			<div class="col-md-4 col-md4">
					<div class="col-md1 simpleCart_shelfItem">
						<a href="single.php">
							<img class="img-responsive" src="images/s1.jpeg" alt="" />
						</a>
			...
			<div class="col-md-4 col-md4">
					<div class="col-md1 simpleCart_shelfItem">
						<a href="single3.php">
							<img class="img-responsive" src="images/s11.jpeg" alt="" />
						</a>
						<h3><a href="single3.php">shirt</a></h3>
						<div class="price">
								<h5 class="item_price">&#8377; 499</h5>
								<a href="#" class="item_add">Add To Cart</a>
								<div class="clearfix"> </div>
