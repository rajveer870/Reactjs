...
<div class="col-md-9">
	<div class="col-md-5 grid">		
		<div class="flexslider">
			  <ul class="slides">
			    <li data-thumb="images/sh24.jpeg">
			        <div class="thumb-image"> <img src="images/sh24.jpeg" data-imagezoom="true" class="img-responsive"> </div>
			    </li>
			    <li data-thumb="images/sh25.jpeg">
			         <div class="thumb-image"> <img src="images/sh25.jpeg" data-imagezoom="true" class="img-responsive"> </div>
			    </li>
			    <li data-thumb="images/sh26.jpeg">
			       <div class="thumb-image"> <img src="images/sh26.jpeg" data-imagezoom="true" class="img-responsive"> </div>
			    </li> 
				<li data-thumb="images/sh27.jpeg">
				   <div class="thumb-image"> <img src="images/sh27.jpeg" data-imagezoom="true" class="img-responsive"></div>
				</li>
				
				<li data-thumb="images/sh28.jpeg">
				   <div class="thumb-image"> <img src="images/sh28.jpeg" data-imagezoom="true" class="img-responsive"></div>
				</li>
				<li data-thumb="images/sh29.jpeg">
				   <div class="thumb-image"> <img src="images/sh29.jpeg" data-imagezoom="true" class="img-responsive"></div>
				</li>
...
<div class="col-md-7 single-top-in">
						<div class="single-para simpleCart_shelfItem">
							<h2>men's branded shoes and footwear with latest collection</h2>
							<p>Alberto Torresi Men Shoe latest modern desing 2019.</p>
							<div class="star-on">
								<ul>
							...
							<div class="clearfix"> </div>
								...
								<label  class="add-to item_price">&#8377; 699</label>
			...
			<div class="content-top1">
				<div class="col-md-4 col-md4">
					<div class="col-md1 simpleCart_shelfItem">
						<a href="sh15.php">
							<img class="img-responsive" src="images/sh15.jpeg" alt="" />
						</a>
						<h3><a href="sh15.php">Shoes</a></h3>
						<div class="price">  
								<h5 class="item_price">&#8377; 959</h5>
			...
			<div class="col-md-4 col-md4">
					<div class="col-md1 simpleCart_shelfItem">
						<a href="sh30.php">
							<img class="img-responsive" src="images/sh30.jpeg" alt="" />
						</a>
						<h3><a href="sh30.php">Shoes</a></h3>
						<div class="price">
								<h5 class="item_price">&#8377; 949</h5>
								<a href="#" class="item_add">Add To Cart</a>
								<div class="clearfix"> </div>
						</div>
			...
			<div class="col-md-4 col-md4">
					<div class="col-md1 simpleCart_shelfItem">
						<a href="sh11.php">
							<img class="img-responsive" src="images/sh11.jpeg" alt="" />
						</a>
						<h3><a href="sh11.php"> Shoes</a></h3>
						<div class="price">
