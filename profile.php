...
$query="SELECT * FROM register WHERE emails='$x'";
...
echo"<center align='left' ><font size='30px' color=pink>";echo"Name:";echo"</font>";echo"<font size='30px' color=purple>";echo "$row[fname]\n $row[lname]";echo"</font>";echo"</center>";
echo"<center align='left' ><font size='30px' color=pink>";echo"Email:";echo"</font>";echo"<font size='30px' color=purple>";echo "$row[emails]";echo"</font>";echo"</center>";
echo"<center align='left' ><font size='30px' color=pink>";echo"Gender:";echo"</font>";echo"<font size='30px' color=purple>";echo "$row[gender]";echo"</font>";echo"</center>";
echo"<center align='left' ><font size='30px' color=pink>";echo"D.O.B:";echo"</font>";echo"<font size='30px' color=purple>";echo "$row[dob]";echo"</font>";echo"</center>";
echo"<center align='left' ><font size='30px' color=pink>";echo"Nationality:";echo"</font>";echo"<font size='30px' color=purple>";echo "$row[nationality]";echo"</font>";echo"</center>";
echo"<center align='left' ><font size='30px' color=pink>";echo"Contact no-:";echo"</font>";echo"<font size='30px' color=purple>";echo "$row[con_no]";echo"</font>";echo"</center>";
}
}
?>
...
<input type="submit" name="logout_btn" value="logout"><br><br>
</form></center>
