...
<form action="aa.php" method="POST"><table width="50%">
<tr><td>

CUSTOMER NAME:</td><td><input type="text" name="cname"></td></tr>
<tr><td>Phone no:</td><td><input type="digit" name="phn"></td></tr>
<tr><td>CUSTOMER ADDRESS:</td><td><input type="text" name ="caddress"></td></tr>
