...
<div class="col-md-9">
	<div class="col-md-5 grid">		
		<div class="flexslider">
			  <ul class="slides">
			    <li data-thumb="images/ts14.jpeg">
			        <div class="thumb-image"> <img src="images/ts14.jpeg" data-imagezoom="true" class="img-responsive"> </div>
			    </li>
			    <li data-thumb="images/ts15.jpeg">
			         <div class="thumb-image"> <img src="images/ts15.jpeg" data-imagezoom="true" class="img-responsive"> </div>
			    </li>
			    <li data-thumb="images/ts16.jpeg">
			       <div class="thumb-image"> <img src="images/ts16.jpeg" data-imagezoom="true" class="img-responsive"> </div>
			    </li> 
...
<div class="col-md-7 single-top-in">
			...
			<div class="content-top1">
				<div class="col-md-4 col-md4">
					<div class="col-md1 simpleCart_shelfItem">
						...
						<h3><a href="tsingle2.php">T-shirt</a></h3>
						<div class="price">  
			...
			<div class="col-md-4 col-md4">
					<div class="col-md1 simpleCart_shelfItem">
						...
						<h3><a href="tsingle4.php">T-shirt</a></h3>
						<div class="price">
								<h5 class="item_price">&#8377; 599</h5>
								<a href="#" class="item_add">Add To Cart</a>
								<div class="clearfix"> </div>
			...
			<div class="col-md-4 col-md4">
					<div class="col-md1 simpleCart_shelfItem">
						...
						<h3><a href="tsingle6.php">T-shirt</a></h3>
						<div class="price">
								<h5 class="item_price">&#8377; 599</h5>
								<a href="#" class="item_add">Add To Cart</a>
								<div class="clearfix"> </div>
