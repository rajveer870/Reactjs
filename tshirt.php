		...
		<div class="col-md-9">
			<div class="content-top1">
				<div class="col-md-4 col-md4">
					<div class="col-md1 simpleCart_shelfItem">
						<a href="tsingle.php">
							<img class="img-responsive" src="images/ts1.jpeg" alt="" />
						</a>
						<h3><a href="tsingle.php">T-shirts</a></h3>
						<div class="price">
			...
			<div class="col-md-4 col-md4">
					<div class="col-md1 simpleCart_shelfItem">
						...
						<h3><a href="tsingle2.php">T-shirts</a></h3>
						<div class="price">
								<h5 class="item_price">&#8377; 499</h5>
								<a href="#" class="item_add">Add To Cart</a>
								<div class="clearfix"> </div>
			...
			<div class="col-md-4 col-md4">
					<div class="col-md1 simpleCart_shelfItem">
						<a href="tsingle5.php">
							<img class="img-responsive" src="images/ts14.jpeg" alt="" />
						</a>
						<h3><a href="tsingle5.php">T-shirt</a></h3>
						<div class="price">
								<h5 class="item_price">&#8377; 499</h5>
								<a href="#" class="item_add">Add To Cart</a>
								<div class="clearfix"> </div>
			...
			<div class="col-md-4 col-md4">
					<div class="col-md1 simpleCart_shelfItem">
						<a href="tsingle6.php">
							<img class="img-responsive" src="images/ts17.jpeg" alt="" />
						</a>
			...
			<div class="content-top1">
				<div class="col-md-4 col-md4">
					<div class="col-md1 simpleCart_shelfItem">
						<a href="tsingle7.php">
							<img class="img-responsive" src="images/ts20.jpeg" alt="" />
						</a>
						<h3><a href="tsingle7.php">T-shirt</a></h3>
						<div class="price">
								<h5 class="item_price">&#8377; 599</h5>
								<a href="#" class="item_add">Add To Cart</a>
								<div class="clearfix"> </div>
			...
			<div class="col-md-4 col-md4">
					<div class="col-md1 simpleCart_shelfItem">
						<a href="tsingle8.php">
							<img class="img-responsive" src="images/ts23.jpeg" alt="" />
						</a>
						<h3><a href="tsingle8.php">T-shirt</a></h3>
						<div class="price">
								<h5 class="item_price">&#8377; 499</h5>
								<a href="#" class="item_add">Add To Cart</a>
								<div class="clearfix"> </div>
			...
			<div class="col-md-4 col-md4">
					<div class="col-md1 simpleCart_shelfItem">
						<a href="tsingle9.php">
							<img class="img-responsive" src="images/ts26.jpeg" alt="" />
						</a>
						<h3><a href="tsingle9.php">T-shirt</a></h3>
						<div class="price">
								<h5 class="item_price">&#8377; 499</h5>
								<a href="#" class="item_add">Add To Cart</a>
								<div class="clearfix"> </div>
