...
<div class="col-md-9">
	<div class="col-md-5 grid">		
		<div class="flexslider">
			  <ul class="slides">
			    <li data-thumb="images/wa21.jpeg">
			        <div class="thumb-image"> <img src="images/wa21.jpeg" data-imagezoom="true" class="img-responsive"> </div>
			    </li>
			    <li data-thumb="images/wa22.jpeg">
			         <div class="thumb-image"> <img src="images/wa22.jpeg" data-imagezoom="true" class="img-responsive"> </div>
			    </li>
			    <li data-thumb="images/wa23.jpeg">
			       <div class="thumb-image"> <img src="images/wa23.jpeg" data-imagezoom="true" class="img-responsive"> </div>
			    </li> 
				<li data-thumb="images/wa24.jpeg">
				   <div class="thumb-image"> <img src="images/wa24.jpeg" data-imagezoom="true" class="img-responsive"></div>
				</li>
				<li data-thumb="images/wa25.jpeg">
				   <div class="thumb-image"> <img src="images/wa25.jpeg" data-imagezoom="true" class="img-responsive"></div>
				</li>
...
<div class="col-md-7 single-top-in">
						<div class="single-para simpleCart_shelfItem">
							<h2>Digital and trendy watches for men</h2>
							<p>A durable mineral window protects the dial face, whicj clean features, hour index, minute markers and complementary watch hands. It enables you to easily spice up a normal outfit and add style to your life.</p>
							<div class="star-on">
								<ul>
							...
							<div class="clearfix"> </div>
								...
								<label  class="add-to item_price">&#8377; 499</label>
			...
			<div class="content-top1">
				<div class="col-md-4 col-md4">
					<div class="col-md1 simpleCart_shelfItem">
						<a href="wa16.php">
							<img class="img-responsive" src="images/wa16.jpeg" alt="" />
						</a>
						<h3><a href="wa16.php">Watch</a></h3>
						<div class="price">  
			...
			<div class="col-md-4 col-md4">
					<div class="col-md1 simpleCart_shelfItem">
						<a href="wa11.php">
							<img class="img-responsive" src="images/wa11.jpeg" alt="" />
						</a>
						<h3><a href="wa11.php">Watch</a></h3>
						<div class="price">
								<h5 class="item_price">&#8377; 459</h5>
								<a href="#" class="item_add">Add To Cart</a>
								<div class="clearfix"> </div>
						</div>
			...
			<div class="col-md-4 col-md4">
					<div class="col-md1 simpleCart_shelfItem">
						<a href="wa1.php">
							<img class="img-responsive" src="images/wa1.jpeg" alt="" />
						</a>
						<h3><a href="wa1.php">Watch</a></h3>
						<div class="price">
