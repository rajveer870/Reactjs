	...
	<div class="container">
		...
		<div class="col-md-9">
			<div class="content-top1">
				<div class="col-md-4 col-md4">
					<div class="col-md1 simpleCart_shelfItem">
						<a href="wj1.php">
							<img class="img-responsive" src="images/wj1.jpeg" alt="" />
						</a>
						<h3><a href="wj1.php">Jeans</a></h3>
						<div class="price">
			...
			<div class="col-md-4 col-md4">
					<div class="col-md1 simpleCart_shelfItem">
						<a href="wj10.php">
							<img class="img-responsive" src="images/wj10.jpeg" alt="" />
						</a>
						<h3><a href="wj10.php">Jeans</a></h3>
						<div class="price">
								<h5 class="item_price">&#8377; 999</h5>
								<a href="#" class="item_add">Add To Cart</a>
								<div class="clearfix"> </div>
						</div>
			...
			<div class="content-top1">
				<div class="col-md-4 col-md4">
					<div class="col-md1 simpleCart_shelfItem">
						<a href="wj14.php">
							<img class="img-responsive" src="images/wj14.jpeg" alt="" />
						</a>
						<h3><a href="wj14.php">Jeans</a></h3>
						<div class="price">
			...
			<div class="col-md-4 col-md4">
					<div class="col-md1 simpleCart_shelfItem">
						<a href="wj23.php">
							<img class="img-responsive" src="images/wj23.jpeg" alt="" />
						</a>
						<h3><a href="wj23.php">Jeans</a></h3>
						<div class="price">
			...
			<div class="content-top1">
				<div class="col-md-4 col-md4">
					<div class="col-md1 simpleCart_shelfItem">
						<a href="wj27.php">
							<img class="img-responsive" src="images/wj27.jpeg" alt="" />
						</a>
						<h3><a href="wj27.php">Jeans</a></h3>
						<div class="price">
